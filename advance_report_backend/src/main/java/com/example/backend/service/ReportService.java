...
public interface ReportService {
    ...
    List<ReportDTO> getReportsByDepartmentId(Long departmentId);
    ...
    List<ReportDTO> getAllReportsByYear(int year); // Новый метод
    List<ReportDTO> getReportsByDepartmentIdAndYear(Long departmentId, int year); // Новый метод
